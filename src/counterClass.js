...
(function($PS) {
  ...
  var capture = function(eventFn) {
    return React_Basic_Events.handler(
      Control_Semigroupoid.composeFlipped(React_Basic_Events.semigroupoidBuilder)(preventDefault)(
        Control_Semigroupoid.composeFlipped(React_Basic_Events.semigroupoidBuilder)(stopPropagation)(eventFn)
      )
    );
  };
  ...
  var counter = (function() {
    var render = function(self) {
      return React_Basic_DOM_Generated.div_([
        React_Basic_DOM_Generated.h1_([React_Basic_DOM.text("Counter (PS, class)")]),
        React_Basic_DOM_Generated.p_([
          React_Basic_DOM.text("You clicked " + (Data_Show.show(Data_Show.showInt)(self.state.counter) + " times"))
        ]),
        React_Basic_DOM_Generated.button()({
          onClick: React_Basic_DOM_Events.capture_(
